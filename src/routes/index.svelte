<script>
	...
	import NavMobile from '../components/MobileNav.svelte';
	import Banner from '../components/Banner.svelte';
    import data from '../stringResources'
</script>
<svelte:head>
    <title>{data.name} - {data.job}</title>
</svelte:head>
<!-- Begin Header -->
		...
		<div class="container">
			...
			<div class="columns is-multiline">
				<div class="column is-6 has-vertically-aligned-content" data-aos="fade-right">
					<p class="is-larger">
						&emsp;&emsp;<strong
							>Showcase is a modern, beautiful personal website template to showcase who you are, as
							well as projects you've worked on in the past.</strong
						>
					</p>
					<br />
					<p>
						Showcase was built from the ground up with Bulma to be fast and responsive out of the
						box with all source files well documented for easy to customization. The Showcase
						template gives you a personal space to share what you are all about as a creative
					...
					<div class="columns about-links">
						...
						<div class="column">
							...
							<p class="subheading">example.com</p>
						</div>
					</div>
				</div>
			...
			<div class="columns is-multiline" data-aos="fade-in" data-aos-easing="linear">
				...
				<div class="column is-10 has-text-centered is-offset-1">
					...
					<form action="example.docs">
						<button class="button">
							Download Resume&emsp;<i class="fad fa-download fa-lg" />
						</button>
					</form>
				</div>
			</div>
		...
		<div class="container">
			<div class="columns is-multiline">
				...
				<div class="columns is-12">
					...
					<div class="column is-4 has-text-centered" data-aos="fade-in" data-aos-easing="linear">
						<i class="fas fa-paint-brush fa-3x" />
						<hr />
						<h2>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
							incididunt ut labore et dolore magna aliqua
